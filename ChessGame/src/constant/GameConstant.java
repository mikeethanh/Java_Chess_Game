...
public interface GameConstant {
	static final int GAME_SIZE = 8; //Đây là kích thước của bàn cờ
    static final Dimension BOARD_PANEL_DIMENSION = new Dimension(600, 600);// kích thước của bàn cờ trong giao diện
    //Xác định kích thước của mỗi ô cờ
    ...
    static final String RESOURCE_PATH = "E:\\theFourSemester\\JavaChessGame\\ChessGame\\resources\\";
